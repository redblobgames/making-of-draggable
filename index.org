...
#+begin_export html
<pre data-code="pointer" data-show="left noscroll offset"/>
#+end_export
...
#+begin_export html
<details>
<summary>To handle both mouse and touch events we have lots of event handlers, and that's what I used before 2021. Details→</summary>
<p>
...
#+begin_export html
<pre data-code="pointer" data-show="capture noscroll left" />
#+end_export
...
#+begin_export html
<pre data-code="pointer" data-show="capture" data-highlight="noscroll" />
#+end_export
...
#+begin_export html
<pre data-code="pointer" data-show="capture" data-highlight="offset" />
#+end_export
...
*Try* with the mouse: right click or drag on the circles. Try dismissing the menu with a click elsewhere, or by pressing ~Esc~. Sometimes Circle 1 will get stuck in a dragging state. Behavior varies across browsers and operating systems. The main fix is to only drag on left button, but you might also want to exclude events with ~Ctrl~ pressed:

#+begin_export html
<pre data-code="pointer" data-show="capture" data-highlight="left noctrl" />
#+end_export
...
{ TODO: add a demo for contextmenu.preventDefault() }
...
#+begin_export html
<pre data-code="pointer" data-show="left offset noscroll" data-highlight="noselect nosystemdrag"/>
#+end_export
...
#+begin_export html
<pre data-code="pointer" data-show="capture" data-highlight="chords" />
#+end_export
