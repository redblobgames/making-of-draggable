...
I have a [[href:targets.html#canvas-drag-to-paint][demo]] but haven't written up the code yet.
...
<x:footer>
  ...
  <!-- hhmts start -->Last modified: 16 Feb 2024<!-- hhmts end -->
</x:footer>
#+end_export
