...
#+begin_comment
Topics to be added:
1. accessibility - make the underlying data editable in some other way
2. canceling - can you press Esc or in some other way cancel the drag?
3. constraints - where should they be applied? explain that it can be done outside this code
#+end_comment
