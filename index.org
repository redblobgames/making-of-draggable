...
digraph {
    ...
    edge [fontname=Courier, fontsize=10, fontcolor="#225522", color="#999999", fillcolor="#ffffff"];
...
#+results:
[[file:diagram-mouse-local.svg]]

Try the demo:

#+begin_export html
<figure id="mouse-events-local" class="w-full">
...
#+begin_export html
<figure id="mouse-events-document" class="w-full">
  <svg viewBox="-330 -50 660 100">
    <rect x="-330" y="-50" width="100%" height="100%" fill="url(#pattern-dots)" />
    <g class="draggable">
      <circle stroke="black" stroke-width="0.5" r="30" />
...
#+begin_export html
<figure id="touch-events" class="w-full">
  <svg viewBox="-330 -50 660 100">
    <rect x="-330" y="-50" width="100%" height="100%" fill="url(#pattern-dots)" />
    <g class="draggable">
      <circle stroke="black" stroke-width="0.5" r="30" />
...
#+begin_export html
<figure id="pointer-events" class="w-full">
  <svg viewBox="-330 -50 660 100">
    <rect x="-330" y="-50" width="100%" height="100%" fill="url(#pattern-dots)" />
    <g class="draggable">
      <circle stroke="black" stroke-width="0.5" r="30" />
...
#+begin_export html
<style>
  svg { background: #eee; box-shadow: 0 1px 3px 1px rgb(0 0 0 / 0.3); width: 100%; }
