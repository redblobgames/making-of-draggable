...
To handle both mouse and touch events we end up having lots of different event handlers, and that's what I had to do [[/x/1845-draggable/][before 2021]]:
...
It requires one additional line of code for common cases, or a second to handle some edge cases:
