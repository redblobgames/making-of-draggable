...
3. constrain position to a non-rectangular area, like my [[href:/articles/curved-paths/making-of.html][making-of curved-paths page]]
4. some way to cancel a drag with keyboard → probably outside the scope
5. .dragging class options (from little-details page)
...
1. move the vue example from the main page to here
2. [[https://sfc.vuejs.org/#][nested draggables]], where both the yellow and red boxes are draggable. Modified recipe: use =stopPropagation()= to prevent the pointer event from going up to the parent element
3. accessibility? - make the numbers also show up in an input box, or make things draggable by keyboard? - something for the vue playground
